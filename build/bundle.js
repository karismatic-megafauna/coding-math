...
/***/ function(module, exports, __webpack_require__) {
	...
	var _main2 = __webpack_require__(192);
	
	var _main3 = __webpack_require__(193);
	
	var _main4 = __webpack_require__(194);
	
	var _main5 = __webpack_require__(195);
	
	var _main6 = __webpack_require__(196);
	
	var _main7 = __webpack_require__(198);
	
	var _main8 = __webpack_require__(200);
	
	var _main9 = __webpack_require__(201);
	
	var _main10 = __webpack_require__(202);
	
	var sidebar = document.querySelector('#sidebar');
	
	var components = {
	  'Random Lines': _main.randomLines,
	  'Sin and Cos': _main2.sinAndCos,
	  'Growing Circle': _main3.growingCircle,
	  'Circle of Circles': _main4.circleOfCircles,
	  'Point at mouse': _main5.pointAtMouse,
	  'Vector Lib': _main6.vectorLib,
	  'Big Bang': _main7.bigBang,
	  'Particle Move': _main8.particleMove,
	  'Fireworks': _main8.fireWorks,
	  'Ship': _main9.ship,
	  'Orbit': _main10.orbit
	};
	
	var currentComponentName = 'Random Lines';
	...
	function render() {
	  var currentComponent = getComponent(currentComponentName);
	  currentComponent.setUp();
	}
	
	function clearSidebar() {
	  var children = Array.from(sidebar.childNodes);
	  children.map(function (child) {
	    return child.classList.remove('current');
	  });
	}
	
	var linkClick = function linkClick(e) {
	  clearSidebar();
	  e.target.className += ' current';
	  var prevComp = getComponent(currentComponentName);
	  prevComp.tearDown();
...
/***/ function(module, exports) {
	...
	var randomLines = exports.randomLines = {
...
/***/ function(module, exports) {
	...
	var sinAndCos = exports.sinAndCos = {
	  tearDown: function tearDown() {
	    // nothing to do yet
	  },
	  setUp: function setUp() {
...
/***/ function(module, exports) {
	...
	var switcher = { on: false };
	var frameId = undefined;
	
	var growingCircle = exports.growingCircle = {
	  tearDown: function tearDown() {
	    switcher.on = false;
...
/***/ function(module, exports) {
	...
	var circleOfCircles = exports.circleOfCircles = {
	  tearDown: function tearDown() {
	    // nothing to do yet
	  },
	  setUp: function setUp() {
	    ...
	    var width = canvas.width = window.innerWidth;
	    var height = canvas.height = window.innerHeight;
	    var randNum = Math.floor(Math.random() * 200) + 100;
	    var randNum2 = Math.floor(Math.random() * 30) + 10;
...
/***/ function(module, exports) {
	...
	var switcher = { on: true };
	var frameId = undefined;
	
	var pointAtMouse = exports.pointAtMouse = {
	  tearDown: function tearDown() {
	    switcher.on = false;
	    cancelAnimationFrame(frameId);
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.vectorLib = undefined;
	
	var _vector = __webpack_require__(197);
	
	var vectorLib = exports.vectorLib = {
	  tearDown: function tearDown() {
	    // nothing to do yet
	  },
	  setUp: function setUp() {
	    var v1 = _vector.vector.create(10, 5);
	    // Adding
	    var v2 = _vector.vector.create(1, 2);
	    var v3 = v1.add(v2);
	    // Subtracting
...
/***/ function(module, exports) {
	...
	var vector = exports.vector = {
	  ...
	  addTo: function addTo(vect) {
	    this._x += vect.getX();
	    this._y += vect.getY();
	  },
	  subtractFrom: function subtractFrom(vect) {
	    this._x -= vect.getX();
	    this._y -= vect.getY();
	  },
	  multiplyBy: function multiplyBy(val) {
	    this._x *= val;
	    this._y *= val;
	  },
	  divideBy: function divideBy(val) {
	    this._x /= val;
	    this._y /= val;
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.bigBang = undefined;
	
	var _particle = __webpack_require__(199);
	
	var switcher = { on: true };
	var frameId = undefined;
	
	var bigBang = exports.bigBang = {
	  tearDown: function tearDown() {
	    switcher.on = false;
	    cancelAnimationFrame(frameId);
	  },
	  setUp: function setUp() {
	    ...
	    for (var i = 0; i < numParticles; i++) {
	      particles.push(_particle.particle.create(width / 2, height / 2, Math.random() * 4 + 1, Math.random() * Math.PI * 2));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var particle = exports.particle = {
	  ...
	  create: function create(x, y, speed, direction, grav) {
	    var obj = Object.create(this);
	    obj.position = _vector.vector.create(x, y);
	    obj.velocity = _vector.vector.create(0, 0);
	    obj.velocity.setLength(speed);
	    obj.velocity.setAngle(direction);
	    obj.gravity = _vector.vector.create(0, grav || 0);
	    return obj;
	  },
	  accelerate: function accelerate(accel) {
	  ...
	  gravitateTo: function gravitateTo(p2) {
	    var grav = _vector.vector.create(0, 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.fireWorks = exports.particleMove = undefined;
	...
	var particleMove = exports.particleMove = {
	  tearDown: function tearDown() {
	    switcher.on = false;
	    cancelAnimationFrame(frameId);
	  },
	  setUp: function setUp() {
	    ...
	    var width = canvas.width = window.innerWidth;
	    var height = canvas.height = window.innerHeight;
	    var p = _particle.particle.create(100, height, 10, -Math.PI / 2);
	    var accel = _vector.vector.create(0.1, 0.1);
	...
	var fireWorks = exports.fireWorks = {
	  tearDown: function tearDown() {
	    switcher.on = false;
	    cancelAnimationFrame(frameId);
	  },
	  setUp: function setUp() {
	    ...
	    for (var i = 0; i < numParticles; i++) {
	      particles.push(_particle.particle.create(width / 2, height / 3, Math.random() * 5 + 2, Math.random() * Math.PI * 2, 0.1));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ship = exports.ship = {
	  ...
	  setUp: function setUp() {
	    ...
	    var width = canvas.width = window.innerWidth;
	    var height = canvas.height = window.innerHeight;
	    var spaceShip = _particle.particle.create(width / 2, height / 2, 0, 0);
	    var thrust = _vector.vector.create(0, 0);
	    var angle = 0;
	    ...
	    function update() {
	      ...
	      context.save();
	      context.translate(spaceShip.position.getX(), spaceShip.position.getY());
	      context.rotate(angle);
	      context.beginPath();
	      context.moveTo(10, 0);
	      context.lineTo(-10, -7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var orbit = exports.orbit = {
	  ...
	  setUp: function setUp() {
	    ...
	    var width = canvas.width = window.innerWidth;
	    var height = canvas.height = window.innerHeight;
	    var sun = _particle.particle.create(width / 2, height / 2, 0, 0);
	    var planet = _particle.particle.create(width / 2 + 200, height / 2, 10, -Math.PI / 2);
